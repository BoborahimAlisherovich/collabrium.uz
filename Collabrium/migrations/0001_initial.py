# Generated by Django 5.0.6 on 2024-12-14 11:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_uz', models.CharField(max_length=300, null=True, verbose_name='Титул')),
                ('title_en', models.CharField(max_length=300, null=True, verbose_name='Титул')),
                ('title_ru', models.CharField(max_length=300, null=True, verbose_name='Титул')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('space_uz', models.CharField(max_length=300, null=True, verbose_name='места')),
                ('space_en', models.CharField(max_length=300, null=True, verbose_name='места')),
                ('space_ru', models.CharField(max_length=300, null=True, verbose_name='места')),
                ('page_slug', models.SlugField(unique=True, verbose_name='Слаг страницы')),
