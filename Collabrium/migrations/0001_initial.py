# Generated by Django 5.0.6 on 2024-12-17 14:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=300, verbose_name='Заголовок')),
                ('text', ckeditor.fields.RichTextField(verbose_name='Текст')),
                ('space', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='minfaq', to='Collabrium.space', verbose_name='вопросы')),
            ],
            options={
                'verbose_name': 'вопросы вопросы',
                'verbose_name_plural': 'вопросы вопросы',
            },
        ),
        migrations.CreateModel(
            name='Jihoz',
