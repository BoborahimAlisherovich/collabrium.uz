# Generated by Django 5.0.6 on 2024-12-21 14:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration', models.CharField(blank=True, help_text="Davomiylik, masalan: '1 oy', '3 oy', '1 yil'", max_length=50, null=True)),
                ('duration_uz', models.CharField(blank=True, help_text="Davomiylik, masalan: '1 oy', '3 oy', '1 yil'", max_length=50, null=True)),
                ('duration_en', models.CharField(blank=True, help_text="Davomiylik, masalan: '1 oy', '3 oy', '1 yil'", max_length=50, null=True)),
                ('duration_ru', models.CharField(blank=True, help_text="Davomiylik, masalan: '1 oy', '3 oy', '1 yil'", max_length=50, null=True)),
                ('price', models.DecimalField(decimal_places=2, max_digits=10)),
                ('space', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tariflar', to='Collabrium.space')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plans', models.ManyToManyField(related_name='Plansedescriptions', to='Collabrium.tarif')),
            ],
        ),
    ]
