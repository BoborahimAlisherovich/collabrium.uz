# Generated by Django 5.1 on 2024-12-25 16:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('space_uz', models.CharField(max_length=300, null=True, verbose_name='зона')),
                ('space_en', models.CharField(max_length=300, null=True, verbose_name='зона')),
                ('space_ru', models.CharField(max_length=300, null=True, verbose_name='зона')),
                ('page_slug', models.SlugField(blank=True, editable=False, unique=True, verbose_name='Слаг страницы')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('space', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='jihozlar', to='Collabrium.space', verbose_name='Связанное пространство')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text_uz', ckeditor.fields.RichTextField(null=True, verbose_name='Текст')),
                ...
                ('page_slug', models.SlugField(blank=True, editable=False, unique=True, verbose_name='Слаг страницы')),
                ('space', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Collabrium.space', verbose_name='Зона')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration', models.CharField(blank=True, help_text="Davomiylik, masalan: '1 oy', '3 oy', '1 yil'", max_length=50, null=True, verbose_name='Продолжительность')),
                ('duration_uz', models.CharField(blank=True, help_text="Davomiylik, masalan: '1 oy', '3 oy', '1 yil'", max_length=50, null=True, verbose_name='Продолжительность')),
                ('duration_en', models.CharField(blank=True, help_text="Davomiylik, masalan: '1 oy', '3 oy', '1 yil'", max_length=50, null=True, verbose_name='Продолжительность')),
                ('duration_ru', models.CharField(blank=True, help_text="Davomiylik, masalan: '1 oy', '3 oy', '1 yil'", max_length=50, null=True, verbose_name='Продолжительность')),
                ('price', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Цена')),
                ('space', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Определения', to='Collabrium.space')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_uz', models.CharField(max_length=200, null=True, verbose_name='текст')),
                ('description_en', models.CharField(max_length=200, null=True, verbose_name='текст')),
                ('description_ru', models.CharField(max_length=200, null=True, verbose_name='текст')),
                ('plans', models.ManyToManyField(related_name='Plansedescriptions', to='Collabrium.tarif', verbose_name='подписка')),
            ],
            options={
                'verbose_name': 'Услуга',
